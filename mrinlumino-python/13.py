...
# A function that finds the position with the lowest weight value and returns its position
...
# Start from the target position and walk backwards using the lowest available value path
